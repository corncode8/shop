...
<div class="full-bg">
	<div class="table">
		<div class="table-cell">
  				<form action="<%=application.getContextPath()%>/sellerjoinProc" method="post" onsubmit="return cheakFunction();" name="form" id="form">
...
<%--                        <input type="text" id ="userId" name="userId" class="form-input" value="">--%>
                        ...
                        <input type="text" id ="email" name="email" class="form-input" value="">
...
<%--                        <input type="text" id ="userAddr" name="userAddr" class="form-input" value="" onClick="goPopup();">--%>
                        ...
                        <input type="text" id ="phone" name="phone" class="form-input" value="" onKeyup="this.value=this.value.replace(/[^0-9]/g,'')">
