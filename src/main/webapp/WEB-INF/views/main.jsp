    ...
    <div class="main__list__container">
        <c:forEach items="${listLastest}" var="lastest">
            <div class="main__list">
                ...
                <a href="./detail.html" class="info__icon__new" style="display: none; border: none;"></a>
                <a href="./detail.html" class="info__price">${lastest.productPrice} WON</a>
            </div>
        </c:forEach>
    </div>
    ...
    <div class="main__list__container">
        <c:forEach items="${listPopular}" var="popular">
            <div class="main__list">
                ...
                <a href="./detail.html" class="info__icon__new" style="display: none; border: none;"></a>
                <a href="./detail.html" class="info__price">${popular.productPrice} WON</a>
            </div>
